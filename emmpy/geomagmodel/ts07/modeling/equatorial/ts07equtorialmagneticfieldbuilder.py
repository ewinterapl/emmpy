...
class Ts07EquatorialMagneticFieldBuilder:
    ...
    #    */
    #   public Ts07EquatorialMagneticFieldBuilder withAlbertBessel() {
    #     bessel = new AlbertBesselFunctionEvaluator(14);
    #     return this;
    #   }
    ...
    #    * @return this builder object
    #    */
    #   public Ts07EquatorialMagneticFieldBuilder withTA15deformation(double bzIMF) {
    ...
    #    * @return this builder object
    #    */
    #   public Ts07EquatorialMagneticFieldBuilder withEquatorialShielding() {
    #     includeShield = true;
    #     return this;
    #   }
    ...
    #    * @return this builder object
    #    */
    #   public Ts07EquatorialMagneticFieldBuilder withoutEquatorialShielding() {
    #     includeShield = false;
    #     return this;
    #   }
    ...
    #     int numCurrSheets = coeffs.getCurrThicks().size();
