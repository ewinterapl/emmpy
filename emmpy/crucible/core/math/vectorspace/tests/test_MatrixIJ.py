...
class TestBuilder(unittest.TestCase):
    ...
    def test_invert(self):
        ...
        self.assertAlmostEqual(m.ij, 3/2)
        self.assertAlmostEqual(m.jj, -1/2)

    def test_invort(self):
        a = pi/3
        m = MatrixIJ(cos(a), sin(a), -sin(a), cos(a))
        m.invort()
        self.assertAlmostEqual(m.ii, cos(a))
        self.assertAlmostEqual(m.ji, -sin(a))
        self.assertAlmostEqual(m.ij, sin(a))
        self.assertAlmostEqual(m.jj, cos(a))
