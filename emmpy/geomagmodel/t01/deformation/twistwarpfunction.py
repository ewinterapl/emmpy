...
# /**
#  * Defines a transformation that deforms the polar angle to introduce a twisting of the tail current
#  * sheet and a tilt warping in the Y-Z plane and its partial derivatives with respect to the
#  * original coordinates cylindrical coordinates. From Tsgyanenko 1998, Modeling of twisted/warped
#  * magnetospheric configurations using the general deformation method, eq. 14.
#  * <p>
...
#  * twist parameter.
#  * <p>
#  * The class {@link FDerivatives} holds references to the value F and the partial derivatives of F
