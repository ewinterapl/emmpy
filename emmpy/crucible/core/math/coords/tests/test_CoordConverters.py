...
class TestBuilder(unittest.TestCase):
    ...
    def test_convert(self):
        ...
        self.assertAlmostEqual(cartesian.getI(), -0.4161468365471424)
        self.assertAlmostEqual(cartesian.getJ(), 0.9092974268256817)
        self.assertAlmostEqual(cartesian.getK(), 3)
        latitudinal = LatitudinalVector(1, 2, 3)
        cartesian = CoordConverters.convert(latitudinal)
        self.assertAlmostEqual(cartesian.getI(), 0.411982245665683)
        self.assertAlmostEqual(cartesian.getJ(), -0.05872664492762098)
        self.assertAlmostEqual(cartesian.getK(), 0.9092974268256817)
        ...
        self.assertAlmostEqual(cartesian.getI(), 0.411982245665683)
        self.assertAlmostEqual(cartesian.getJ(), -0.9001976297355174)
        self.assertAlmostEqual(cartesian.getK(), 0.1411200080598672)
        spherical = SphericalVector(1, 2, 3)
        cartesian = CoordConverters.convert(spherical)
        self.assertAlmostEqual(cartesian.getI(), -0.9001976297355174)
        self.assertAlmostEqual(cartesian.getJ(), 0.12832006020245673)
        self.assertAlmostEqual(cartesian.getK(), -0.4161468365471424)
