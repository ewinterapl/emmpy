...
class Ts07DFieldAlignedMagneticField(BasisVectorField):
    ...
    #   private final ImmutableList<VectorField> internalFields;
    #   private final ImmutableList<VectorField> shieldingFields;
    #   private final VectorField internalField;
    #   private final VectorField shieldingField;
    #   private final ImmutableList<VectorField> basisFunctions;
    #   private final ImmutableList<Double> basisCoefficients;
    #   private final boolean includeShielding;
