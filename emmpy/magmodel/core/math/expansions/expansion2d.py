...
class Expansion2D:
    ...
    bound index (U), where T is any {@link Object}.

    This is similar to a 2-D array or {@link List} of Ts, but with a non-zero
    starting index. If the object is a {@link Double}, the interface
    {@link CoefficientExpansion2D} can be used instead to avoid autoboxing.
